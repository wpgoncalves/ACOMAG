# Generated by Django 4.0.2 on 2022-03-18 13:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='phones',
            constraint=models.UniqueConstraint(fields=('number',), name='phones_constraints'),
        ),
        migrations.AddConstraint(
            model_name='emails',
            constraint=models.UniqueConstraint(fields=('email',), name='emails_constraints'),
        ),
        migrations.AddField(
            model_name='customers',
            name='address',
            field=models.ManyToManyField(to='poboxes.Adresses', verbose_name='Endereço'),
        ),
        migrations.AddField(
            model_name='customers',
            name='emails',
            field=models.ManyToManyField(to='poboxes.Emails', verbose_name='E-mails'),
        ),
        migrations.AddField(
            model_name='customers',
            name='phones',
            field=models.ManyToManyField(to='poboxes.Phones', verbose_name='Telefones'),
        ),
        migrations.AddConstraint(
            model_name='adresses',
            constraint=models.UniqueConstraint(fields=('cep',), name='cep_constraints'),
        ),
        migrations.AddConstraint(
            model_name='customers',
            constraint=models.UniqueConstraint(fields=('cpf_cnpj',), name='cpf_cnpj_constraints'),
        ),
    ]
